...
public class GRectangle extends GShape {
	...
	public void resize(int x, int y) {
		...
		case NN:
			this.rectangle.height = this.rectangle.height + this.rectangle.y-y;
			this.rectangle.y = y;
			break;
		case NE:
			this.rectangle.height = this.rectangle.height + this.rectangle.y-y;
		...
		case NW:
			...
			this.rectangle.y = y;this.rectangle.x = x;
			break;
		case SS:
			this.rectangle.height = y - this.rectangle.y;	
			break;
		...
		case EE:
			...
			break;
		case WW:
			this.rectangle.width = this.rectangle.width + this.rectangle.x-x;
			this.rectangle.x = x;
			break;
		default:
			break;
